...
setup(
    ...
    long_description="""
        This package provides tools for reading, analyzing, manipulating,
        storing, retrieving, viewing, and evaluating, information processing
        operations on audio files, including speech, music, and other mixed
        audio.""",
